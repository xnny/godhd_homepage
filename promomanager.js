AC.PromoManager=Class.create();
AC.PromoManager.instances=$A();
Object.extend(
	AC.PromoManager.prototype,
	{initialize:function(b,h)
		{
			if(typeof AC.Storage=="undefined")
			{
				return
			}
			AC.PromoManager.instances.push(this);
			this.storageName="pm-"+b;
			this.promos=(typeof h=="string")?$$("."+h):$A(h);
			var a=0,d=-1,g=$A();
			this.promos.each(function(j,k){if(j.nodeType){this.promos[k]={promo:j};
...
}this.selectPromo(a,b)}});
AC.PromoManager.Rotation=Class.create();AC.PromoManager.Rotation.options={interval:3,animationDuration:0.5};
